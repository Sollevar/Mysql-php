...
<body>
    ...
    <a href="../index.php" class="floating-button form-btn">Вернуться на главную</a>
            <div class="person__add">
                <h2 class="title-h2">Добавить отдел</h2>
                <form class='form-add' action="create_dep.php" method="post">
                    <label for="dep">
                        Название Отдела
                        <input type="text" name="dep" id="dep" placeholder="Введите название отдела" require>
                    </label>
                    <button type="submit" class="floating-button btn-submit">Добавить отдел</button>
                </form>
        </div> 
    </div>   
</body>
